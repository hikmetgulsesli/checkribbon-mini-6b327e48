...
- CheckRibbon Mini turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called CheckRibbon Mini. It should show four checklist items, a selected active item, a progress meter, and a compact settings panel. Use static HTML/CSS/JS only. Keep it useful from the first viewport, no landing page.
...
- Record Operations - CheckRibbon Mini
- Record Editor - CheckRibbon Mini
- Settings and Preferences - CheckRibbon Mini
- Insights - CheckRibbon Mini

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - CheckRibbon Mini
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - CheckRibbon Mini
...
SCREEN_SPEC_3:
- exact_screen_title: Settings and Preferences - CheckRibbon Mini
...
SCREEN_SPEC_4:
- exact_screen_title: Insights - CheckRibbon Mini
